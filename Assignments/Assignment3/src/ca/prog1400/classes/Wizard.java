...
public class Wizard extends Player{
    public Wizard(String charName, int hitPoint, int defensePoint, int agilityPoint, int baseAttackPoint, String desc, String imageAddr, String playerName, Weapon weapon) {
