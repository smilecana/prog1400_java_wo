...
public class Cleric extends Player{
    public Cleric(String charName, int hitPoint, int defensePoint, int agilityPoint, int baseAttackPoint, String desc, String imageAddr, String playerName, Weapon weapon) {
